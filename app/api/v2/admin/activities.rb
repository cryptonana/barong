      ...
      class Activities < Grape::API
        helpers do
          def permitted_search_params(params)
            ...
            params.slice(:action, :uid, :email, :topic, :from, :to, :range, :target_uuid).merge(with_user: true, ordered: true)
          end
        end
        ...
        resource :activities do
          ...
          params do
            ...
            optional :email,
                     type: { value: String, message: 'admin.activity.non_string_email' }
            optional :target_uuid,
                     type: { value: String, message: 'admin.activity.non_string_target_uuid' }
            optional :range,
                     type: String,
